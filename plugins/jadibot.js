...
let handler  = async (m, { conn, args, usedPrefix, command }) => {
  ...
  } else throw '*「 ℱʂơƈıɛɬყ ცơɬ 」*\n\n*❰ ⚠️ ❱ No se puede hacer un bot dentro de un sub bot!*\n*✳️ Use el comando #nutriabot al numero oficial/principal del Bot*\n\n*👉 https://wa.me/' + global.conn.user.jid.split`@`[0] + '?text=#nutriabot*\n\n*「 ℱʂơƈıɛɬყ ცơɬ 」*'
}
handler.help = ['nutriabot']
handler.tags = ['nutriabot']

handler.command = /^serbot|nutriabot|sersubbot|sersubot$/i
handler.prems = false
